...
copy public.Commentators(nickname, first_name, second_name, country, age) from '/Commentators.csv' delimiter '|' csv;

copy public.Matches(team1_id, team2_id, winner_id, commentator_id, tournament_name, date) from '/Matches.csv' delimiter '|' csv;
