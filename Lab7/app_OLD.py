...
from playhouse.db_url import PostgresqlDatabase
from playhouse.shortcuts import Cast
import peewee as pw

#db = connect("postgresext://postgres:tCH@4b5H@localhost:5432/rk3")
db = PostgresqlDatabase(None)
db.init('postgres', host='localhost', user='postgres', password='postgres')
#db.connect()
